...
export default function AssetValueAnalysis({ className }: AssetValueAnalysisProps) {
    ...
    <Card className={cn("overflow-hidden transition-all duration-300 border border-gray-200 shadow-sm", className)}>
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-md">자산 가치 분석</CardTitle>
            <p className="text-sm text-gray-500 mt-1">시장 지표 및 예측</p>
          </div>
