              ...
              <SheetContent className="bg-gradient-to-b from-white to-pink-50 border-l border-pink-100">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  >
                    ...
                    <Code className="h-5 w-5 mr-2 z-10 text-pink-600" />
                    <div className="flex flex-col">
                      <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-purple-600">AI 어시스턴트</span>
